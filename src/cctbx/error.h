  ...
  class error : public ::scitbx::error_base<error>
  {
    public:
      ...
      error(std::string const& msg) throw()
        : ::scitbx::error_base<error>("cctbx", msg)
      {}
      ...
      error(const char* file, long line, std::string const& msg = "",
        ...
        : ::scitbx::error_base<error>("cctbx", file, line, msg, internal)
      {}
  };
...
#define CCTBX_ERROR(msg) \
  SCITBX_ERROR_UTILS_REPORT(cctbx::error, msg)
//! For throwing an "Internal Error" exception.
#define CCTBX_INTERNAL_ERROR() \
  SCITBX_ERROR_UTILS_REPORT_INTERNAL(cctbx::error)
//! For throwing a "Not implemented" exception.
#define CCTBX_NOT_IMPLEMENTED() \
  SCITBX_ERROR_UTILS_REPORT_NOT_IMPLEMENTED(cctbx::error)

//! Custom cctbx assertion.
#define CCTBX_ASSERT(assertion) \
  SCITBX_ERROR_UTILS_ASSERT(cctbx::error, CCTBX_ASSERT, assertion)
